                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="campaignname"
                                value='<?php echo $row['campaignname']; ?>' placeholder="Enter Campaign Name" required>
                        </div>

                        <div class="form-group">
                            <label for="exampleInputPassword1">Organizer Name</label>
                            <input type="text" class="form-control" name="organizer"
                                value='<?php echo $row['organizer']; ?>' placeholder="Enter Organizer's Name" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="location"
                                value='<?php echo $row['location']; ?>' placeholder="Enter Campaign Location Details"
                                required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="description"
                                value='<?php echo $row['description']; ?>' placeholder="Enter Description" required>
                        </div>

                    </div>
                    <!-- /.box-body -->
                    <!-- id hidden grna input type ma "hidden" -->
                    <input type="hidden" name="id" value="<?php echo $row['id'];?>" <div class="box-footer">
